...
```
Обратите внимание, что версии зависимостей могут варьироваться в зависимости от версии Python, установленной на вашем компьютере.
...
## Использование
### Для администраторов
1. **Вход** - Используйте учётные данные суперпользователя на http://127.0.0.1:8000
2. **Создание пользователей** - Перейдите в "Create User" в навигационной панели
   - Выберите между "Regular User" или "Administrator"
   - Заполните имя пользователя, email и пароль
3. **Загрузка отчётов** - Перейдите в "Admin Panel" для загрузки Excel файлов
4. **Просмотр данных** - Доступ к загруженным отчётам со страницы "Data"


### Для обычных пользователей
1. **Вход** - Используйте учётные данные, предоставленные администратором
2. **Просмотр данных** - Просматривайте загруженные отчёты
